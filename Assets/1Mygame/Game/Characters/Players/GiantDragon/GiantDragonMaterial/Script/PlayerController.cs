...
public class PlayerController : MonoBehaviour, IPunObservable
{
    ...
    [SerializeField] private Transform gun3;
    [SerializeField] private Transform gun4;
    [SerializeField] private Transform gun5;
    ...
    private void Update()
    {
        if (_pv && _pv.IsMine)
        {
            ...
            {
                Instantiate(bullet2, gun2.position, gun2.rotation);
            }
            if (Input.GetKeyDown(KeyCode.Alpha3))
            {
                Instantiate(bullet3, gun3.position, gun3.rotation);
            }
            if (Input.GetKey(KeyCode.Alpha4))
            {
                Instantiate(bullet4, gun4.position, gun4.rotation);
            }
            if (Input.GetKey(KeyCode.Alpha5))
            {
                Instantiate(bullet5, gun5.position, gun5.rotation);
